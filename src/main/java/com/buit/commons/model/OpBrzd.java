 ...
 */
public class OpBrzd  extends PageQuery {
    ...
    /** 诊断类别 | 1 门诊诊断 2....    诊断类别 默认门急诊诊断，不可修改 */
    ...
    /** 设置:附属诊断标志 | 是否包含附属诊断 1 包含 0 不包含 ；包含的话 至少需要维护一个附属诊断  */
    public void setFfbz(Integer value) {
        this.ffbz = value;
    }
    /** 获取:附属诊断标志 | 是否包含附属诊断 1 包含 0 不包含 ；包含的话 至少需要维护一个附属诊断 */
    public Integer getFfbz() {
        return ffbz;
    }

    /** 设置:病理诊断标志 | 1 是 0 否 默认 0  */
    public void setBlzd(Integer value) {
        this.blzd = value;
    }
    /** 获取:病理诊断标志 | 1 是 0 否 默认 0 */
    public Integer getBlzd() {
        return blzd;
    }

    /** 设置:院感诊断标志  */
    public void setYgzd(Integer value) {
        this.ygzd = value;
    }
    /** 获取:院感诊断标志 */
    public Integer getYgzd() {
        return ygzd;
    }
