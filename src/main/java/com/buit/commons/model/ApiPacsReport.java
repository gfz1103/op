 ...
 * @ApiModel(value="接口检查")
 */
public class ApiPacsReport  extends  PageQuery{
	//@ApiModelProperty(value="主键唯一标识")
    /** 主键唯一标识 */
    private Integer id;
	...
	//@ApiModelProperty(value="项目编号，格式为：2302/2308/2375（每个组合项目之间用“/”隔开）")
    /** 项目编号，格式为：2302/2308/2375（每个组合项目之间用“/”隔开） */
	...
	//@ApiModelProperty(value="医技类型1：放射、2：超声、3：内镜、4：心功能、5：特殊治疗、6：病理、7：特殊")
    /** 医技类型1：放射、2：超声、3：内镜、4：心功能、5：特殊治疗、6：病理、7：特殊 */
    private String medicalTechnologyType;
	//@ApiModelProperty(value="影像URL地址")
    /** 影像URL地址 */
