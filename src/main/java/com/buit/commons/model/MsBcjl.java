 ...
 */
public class MsBcjl  extends  PageQuery{
    ...
    private String mxb;
    @ApiModelProperty(value="健康处方维护集合")
    List<HerHealthreciperecordMz> jkcfRecords;
    ...
    /** 设置:病人去向  */
    public void setBrqx(Integer value) {
        this.brqx = value;
    }
    /** 获取:病人去向 */
    ...
    public void setRsbz(Integer value) {
        this.rsbz = value;
    }
    ...
    public List<HerHealthreciperecordMz> getJkcfRecords() {
        return jkcfRecords;
    }

    public void setJkcfRecords(List<HerHealthreciperecordMz> jkcfRecords) {
        this.jkcfRecords = jkcfRecords;
    }
