...
// * @author WY
// */
//@ApiModel(value="门诊_门诊收费信息")
//public class OpMzxxResp  extends  PageQuery{
...
//    @ApiModelProperty(value="病人ID号 | 内部标示一个病人的编号在MPI_BRDA库中每一个MZHM与一个ID号相关联，用于唯一标示一个病人")
...
//    @ApiModelProperty(value="现金金额 | XJJE+ZPJE+QTJE+QTYS+HBWC= OP_SFMX中该发票的ZJJE之和但XJJE+ZPJE+QTJE不一定等于OP_SFMX中该发票的ZFJE之和")
...
//     * 设置:收费日期
//     */
//    public void setSfrq(Timestamp value) {
//        this.sfrq = value;
//    }
//    /**
//     * 获取:收费日期
...
//    }
//    /**
//     * 设置:现金金额 | XJJE+ZPJE+QTJE+QTYS+HBWC= OP_SFMX中该发票的ZJJE之和但XJJE+ZPJE+QTJE不一定等于OP_SFMX中该发票的ZFJE之和
//     */
//    public void setXjje(BigDecimal value) {
//        this.xjje = value;
//    }
//    /**
//     * 获取:现金金额 | XJJE+ZPJE+QTJE+QTYS+HBWC= OP_SFMX中该发票的ZJJE之和但XJJE+ZPJE+QTJE不一定等于OP_SFMX中该发票的ZFJE之和
//     */
