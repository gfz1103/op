...
public class MsBcjlCopyResp extends  PageQuery{
    ...
    private String mxb;
    @ApiModelProperty(value="健康处方集合")
    List<HerHealthreciperecordMzCopyResp> jkcfRecords;
    /**
    ...
    public List<HerHealthreciperecordMzCopyResp> getJkcfRecords() {
        return jkcfRecords;
    }

    public void setJkcfRecords(List<HerHealthreciperecordMzCopyResp> jkcfRecords) {
