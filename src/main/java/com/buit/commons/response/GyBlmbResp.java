...
public class GyBlmbResp  extends PageQuery {
    ...
    @ApiModelProperty(value="老年人健康教育集合")
    private List<PubPelplehealthteachMb> jkcfRecords;
    /**
     * 设置:记录序号 | 主键
     */
    ...
    public List<PubPelplehealthteachMb> getJkcfRecords() {
        return jkcfRecords;
    }

    public void setJkcfRecords(List<PubPelplehealthteachMb> jkcfRecords) {
