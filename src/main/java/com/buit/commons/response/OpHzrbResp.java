...
// * @author WY
// */
//@ApiModel(value="门诊_门诊收费日报")
//public class OpHzrbResp  extends  PageQuery{
...
//    @ApiModelProperty(value="现金金额 | 现金金额、支票金额、帐户自负(帐户金额)、其它应收、货币误差从OP_MZXX的XJJE,ZPJE,ZHJE,QTYS,HBWC中合计得到")
...
//    }
//    /**
//     * 设置:现金金额 | 现金金额、支票金额、帐户自负(帐户金额)、其它应收、货币误差从OP_MZXX的XJJE,ZPJE,ZHJE,QTYS,HBWC中合计得到
//     */
//    public void setXjje(BigDecimal value) {
//        this.xjje = value;
//    }
//    /**
//     * 获取:现金金额 | 现金金额、支票金额、帐户自负(帐户金额)、其它应收、货币误差从OP_MZXX的XJJE,ZPJE,ZHJE,QTYS,HBWC中合计得到
//     */
