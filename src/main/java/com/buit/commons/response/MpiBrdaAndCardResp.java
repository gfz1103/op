...
/**
 * 类名称：MpiBrdaAndCardResp<br>
 * 类描述：建档时根据卡号查询病人信息和卡列表信息<br>
 * 
 * @author WY
 */
@ApiModel(value = "建档时根据卡号查询病人信息和卡列表信息")
public class MpiBrdaAndCardResp extends PageQuery {
