...
public class OpZt01Req  extends PageQuery {
    @NotNull(message = "组套类别 | 1.西药 2.中药 3.草药 4.项目 不能为空")
    @ApiModelProperty(value="组套类别 | 1.西药 2.中药 3.草药 4.项目")
    private Integer ztlb;
    @NotNull(message = "所属类别 | 1.个人组套 2.科室组套 3.公用组套 4.个人常用药 5.科室常用 6.全院常用 不能为空")
    ...
    @ApiModelProperty(value="组套编号", hidden = true)
    private Integer ztbh;
    @ApiModelProperty(value="组套名称", hidden = true)
    private String ztmc;
