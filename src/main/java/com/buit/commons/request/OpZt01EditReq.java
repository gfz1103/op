 ...
 * @author 老花生
 */
@ApiModel(value="门诊医生组套新增")
public class OpZt01EditReq {
    @NotNull(message = "组套编号 不能为空")
    @ApiModelProperty(value="组套编号")
    private Integer ztbh;
    @NotBlank(message = "组套名称 不能为空")
    ...
    @ApiModelProperty(value="所属类别 | 1.个人组套 2.科室组套 3.公用组套 4.个人常用药 5.科室常用 6.全院常用", hidden = true)
    private Integer sslb;
    @ApiModelProperty(value="组套类别 | 1.西药 2.中药 3.草药 4.项目", hidden = true)
    private Integer ztlb;
    @ApiModelProperty(value="拼音码", hidden = true)
    private String pydm;
    @ApiModelProperty(value="关联疾病", hidden = true)
    private Integer gljb;
    @ApiModelProperty(value="项目选取", hidden = true)
    private Integer xmxq;
    @ApiModelProperty(value="是否启用", hidden = true)
    private Integer sfqy;
    @ApiModelProperty(value="科室代码", hidden = true)
    private String ksdm;
    @ApiModelProperty(value="排列顺序", hidden = true)
    private Integer plsx;
    @ApiModelProperty(value="组套类型(关联LIS_JYZTLX表主键ID)", hidden = true)
