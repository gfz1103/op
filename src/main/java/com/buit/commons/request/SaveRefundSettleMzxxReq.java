...
/**
 * 类名称：SaveRefundSettleMzxxReq<br>
 * 类描述：退费处理门诊信息请求<br>
 * 
 * @author WY
 */
@ApiModel(value = "退费处理门诊信息请求")
public class SaveRefundSettleMzxxReq extends PageQuery {
	...
	private List<TfPayTfxxReq> tfxx = new ArrayList<TfPayTfxxReq>();
	@ApiModelProperty(value = "退费处方信息")
	private List<FzxxReq> fzxx = new ArrayList<FzxxReq>();
	...
	public List<TfPayTfxxReq> getTfxx() {
		return tfxx;
	}

	public void setTfxx(List<TfPayTfxxReq> tfxx) {
		this.tfxx = tfxx;
	}
	...
	public List<FzxxReq> getFzxx() {
		return fzxx;
	}

	public void setFzxx(List<FzxxReq> fzxx) {
		this.fzxx = fzxx;
	}
