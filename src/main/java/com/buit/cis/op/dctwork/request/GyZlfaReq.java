...
public class GyZlfaReq extends PageQuery {
    @ApiModelProperty(value="拼音码")
    private String pydm;
    @ApiModelProperty(value="门诊科室", hidden = true)
    private Integer ksdm;
    @ApiModelProperty(value="启用标志 1 启用、 0停用")
    ...
    @ApiModelProperty(value="病例模版序号", hidden = true)
    private Integer blmbbh;
    @ApiModelProperty(value="处方组套序号", hidden = true)
    private Integer cfztbh;
    @ApiModelProperty(value="项目组套序号", hidden = true)
    private Integer xmztbh;
    @ApiModelProperty(value="疾病序号 | 由于增加中医诊断，此处需要存常用诊断表主键", hidden = true)
