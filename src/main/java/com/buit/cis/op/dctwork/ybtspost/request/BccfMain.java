 ...
 * @Description
 **/
@ApiModel(value = "4.4保存处方")
public class BccfMain {
    ...
    @ApiModelProperty(value = "ZD诊断")
    private List<Item<ZdItem>> ZD;

    @ApiModelProperty(value = "YP药品")
    private List<Item<YpItem>> YP;

    @ApiModelProperty(value = "FWXM服务项目")
    private List<Item<FwxmItem>> FWXM;

    @ApiModelProperty(value = "YYCL医用材料")
    private List<Item<YyclItem>> YYCL;
    ...
    public List<Item<ZdItem>> getZD() {
        return ZD;
    }

    public void setZD(List<Item<ZdItem>> ZD) {
        this.ZD = ZD;
    }

    public List<Item<YpItem>> getYP() {
        return YP;
    }

    public void setYP(List<Item<YpItem>> YP) {
        this.YP = YP;
    }

    public List<Item<FwxmItem>> getFWXM() {
        return FWXM;
    }

    public void setFWXM(List<Item<FwxmItem>> FWXM) {
        this.FWXM = FWXM;
    }

    public List<Item<YyclItem>> getYYCL() {
        return YYCL;
    }

    public void setYYCL(List<Item<YyclItem>> YYCL) {
        this.YYCL = YYCL;
    }
}
